...
- **🚀 Скорость** - оптимизированная установка с параллельными загрузками
- **💎 Качество** - тщательно подобранные пакеты и конфигурации
- **🛡️ Безопасность** - проверка цифровых подписей и безопасные настройки
...
- Современные темы GTK и иконки
- Коллекция красивых обоев
- Настроенные шрифты (включая Nerd Fonts)
- Прозрачность и анимации

### ⚡ **Производительность**
- Оптимизированные зеркала пакетов
- Параллельные загрузки (10x ускорение)
- SSD оптимизация
- Современная аудиосистема PipeWire
...
### 📱 **Приложения**
- Современные терминалы (Ghostty, Kitty)
- Полный офисный пакет (OnlyOffice)
...
```bash
git clone https://github.com/Sm1tee/dotfiles.git
cd dotfiles
