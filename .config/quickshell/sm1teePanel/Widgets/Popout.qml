...
PanelWindow {
    ...
    readonly property real alignedX: Theme.snap((() => {
        if (SettingsData.barPosition === SettingsData.Position.Left) {
            return triggerY
        } else if (SettingsData.barPosition === SettingsData.Position.Right) {
    ...
    readonly property real alignedY: Theme.snap((() => {
        if (SettingsData.barPosition === SettingsData.Position.Left || SettingsData.barPosition === SettingsData.Position.Right) {
        ...
        } else if (SettingsData.barPosition === SettingsData.Position.Bottom) {
    ...
    Loader {
        ...
        active: root.visible
        asynchronous: false
        layer.enabled: Quickshell.env("SM1TEE_DISABLE_LAYER") !== "true"
