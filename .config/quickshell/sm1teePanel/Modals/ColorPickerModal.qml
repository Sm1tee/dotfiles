...
PanelWindow {
    ...
    property string pickerTitle: "Выбор цвета"
    ...
    function copyColorToClipboard(colorValue) {
        ...
        ToastService.showInfo(`Цвет ${colorValue} скопирован`)
    ...
    Rectangle {
        ...
        width: Math.max(680, Math.min(900, 680 * SettingsData.fontScale))
        height: Math.max(680, Math.min(900, 680 * SettingsData.fontScale))
            ...
            Column {
                ...
                Row {
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Выберите цвет из палитры или используйте ползунки"
