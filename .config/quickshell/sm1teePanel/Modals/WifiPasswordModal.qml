...
Modal {
    ...
    height: requiresEnterprise ? Math.max(310, Math.min(430, 310 * SettingsData.fontScale)) : Math.max(230, Math.min(320, 230 * SettingsData.fontScale))
