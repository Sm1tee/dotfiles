...
DankModal {
    ...
    property string confirmButtonText: "Подтвердить"
    ...
    allowStacking: true
    width: Math.max(350, Math.min(500, 350 * SettingsData.fontScale))
    height: Math.max(160, Math.min(230, 160 * SettingsData.fontScale))
    enableShadow: true
