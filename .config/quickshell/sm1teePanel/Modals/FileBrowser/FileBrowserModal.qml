...
Modal {
    ...
    width: Math.max(800, Math.min(1100, 800 * SettingsData.fontScale))
    height: Math.max(600, Math.min(850, 600 * SettingsData.fontScale))
    enableShadow: true
    visible: false
            ...
            Item {
                ...
                StyledRect {
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Файл с таким именем уже существует. Хотите перезаписать его?"
                            font.pixelSize: Theme.fontSizeMedium
