...
Item {
    ...
    FileBrowserModal {
        ...
        browserTitle: "Сохранить файл блокнота"
        browserIcon: "save"
        ...
        saveMode: true
        defaultFileName: {
            if (currentTab && currentTab.title && currentTab.title !== "Без названия") {
    ...
    FileBrowserModal {
        ...
        browserTitle: "Открыть файл блокнота"
    ...
    Modal {
        ...
        height: Math.max(180, Math.min(250, 180 * SettingsData.fontScale))
                        ...
                        Column {
                            ...
                            StyledText {
                                text: root.pendingAction === "new" ?
                                      "У вас есть несохраненные изменения. Сохранить перед созданием нового файла?" :
                                      root.pendingAction.startsWith("close_tab_") ?
                                      "У вас есть несохраненные изменения. Сохранить перед закрытием вкладки?" :
                                      root.pendingAction === "load_file" || root.pendingAction === "open" ?
                                      "У вас есть несохраненные изменения. Сохранить перед открытием файла?" :
