...
Column {
    ...
    StyledRect {
        ...
        RowLayout {
            ...
            StyledText {
                Layout.alignment: Qt.AlignVCenter
                text: matchCount > 0 ? (currentMatchIndex + 1) + "/" + matchCount : searchQuery.length > 0 ? "Нет совпадений" : ""
    ...
    StyledRect {
        ...
        DankFlickable {
            ...
            TextArea.flickable: TextArea {
                id: textArea
                placeholderText: "Начните вводить заметки здесь..."
    ...
    Column {
        ...
        Row {
            ...
            StyledText {
                text: textArea.text.length > 0 ? textArea.text.length + " символов" : "Пусто"
                font.pixelSize: Theme.fontSizeSmall
                color: Theme.surfaceTextMedium
            }

            StyledText {
                text: "Строк: " + textArea.lineCount
                font.pixelSize: Theme.fontSizeSmall
                color: Theme.surfaceTextMedium
