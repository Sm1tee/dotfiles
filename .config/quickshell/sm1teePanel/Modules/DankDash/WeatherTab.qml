...
Item {
    ...
    Column {
        ...
        DankIcon {
            name: WeatherService.weather.loading ? "hourglass_empty" : "cloud_off"
            size: Theme.iconSize * 2
            color: Qt.rgba(Theme.surfaceText.r, Theme.surfaceText.g, Theme.surfaceText.b, 0.5)
            anchors.horizontalCenter: parent.horizontalCenter
            
            RotationAnimation on rotation {
                running: WeatherService.weather.loading
                from: 0
                to: 360
                duration: 2000
        ...
        StyledText {
            text: WeatherService.weather.loading ? "Загрузка погоды..." : "Нет данных о погоде"
        ...
        StyledText {
            text: "Проверьте настройки погоды"
