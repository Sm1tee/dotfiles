        ...
        ToggleButton {
            ...
            text: {
                ...
                case "nightMode":
                    return "Ночной режим"
                case "darkMode":
                    return SessionData.isLightMode ? "Светлая тема" : "Темная тема"
                case "doNotDisturb":
                    return "Не беспокоить"
                case "idleInhibitor":
                    return SessionService.idleInhibited ? "Экран не выключается" : "Не выключать экран"
                default:
                    return "Неизвестно"
                }
            }
