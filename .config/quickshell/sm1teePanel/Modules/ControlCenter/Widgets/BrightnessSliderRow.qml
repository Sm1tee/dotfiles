        ...
        MouseArea {
            ...
            onEntered: {
                ...
                if (tooltipLoader.item) {
                    let tooltipText = "Яркость"
                    if (DisplayService.currentDevice) {
                        const deviceInfo = DisplayService.getCurrentDeviceInfo()
                        if (deviceInfo) {
                            if (deviceInfo.class === "ddc") {
                                tooltipText = "Внешний монитор"
                            } else if (deviceInfo.class === "backlight") {
                                tooltipText = "Встроенный дисплей"
                            }
                        }
                    }
    ...
    Menu {
        ...
        Instantiator {
            ...
            delegate: MenuItem {
                ...
                text: {
                    if (deviceClass === "ddc") {
                        return "Внешний монитор (DDC)"
                    } else if (deviceClass === "backlight") {
                        return "Встроенный дисплей"
                    }
                    return deviceName
                }
