...
PanelWindow {
    ...
    readonly property string powerOptionsText: "Параметры питания"
    readonly property string logOutText: "Выйти"
    readonly property string suspendText: "Приостановить"
    readonly property string rebootText: "Перезагрузить"
    readonly property string powerOffText: "Выключить"
