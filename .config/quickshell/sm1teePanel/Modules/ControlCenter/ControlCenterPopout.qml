                    ...
                    onPowerButtonClicked: {
                        if (powerMenuModalLoader) {
                            ...
                            if (powerMenuModalLoader.item) {
                                const buttonPos = headerPane.mapToItem(null, headerPane.width - 36 - Theme.spacingXS, (headerPane.height - 36) / 2)
                                const bounds = Qt.rect(buttonPos.x, buttonPos.y, 36, 36)
