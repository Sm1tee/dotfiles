...
Popout {
    ...
    popupWidth: Math.max(520, Math.min(700, 520 * SettingsData.fontScale))
    popupHeight: Math.max(600, Math.min(800, 600 * SettingsData.fontScale))
    ...
    onShouldBeVisibleChanged: {
        if (shouldBeVisible) {
            ...
            appLauncher.showHidden = false
            appLauncher.setCategory("Все")
            Qt.callLater(() => {
                ...
                Column {
                    ...
                    Item {
                        ...
                        StyledText {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            text: {
                                const count = appLauncher.model.count
                                if (count === 1) return "1 приложение"
                                if (count < 5) return count + " приложения"
                    ...
                    Row {
                        ...
                        ActionButton {
                            ...
                            iconColor: appLauncher.showHidden ? Theme.primary : Theme.surfaceText
                            backgroundColor: appLauncher.showHidden ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.12) : "transparent"
                            anchors.verticalCenter: parent.verticalCenter
                            onClicked: {
                                appLauncher.showHidden = !appLauncher.showHidden
                            }
                        }
    ...
    Popup {
        ...
        readonly property bool isPinnedTop: appId && SessionData.isPinnedTopApp(appId)
        readonly property bool isHidden: appId && SessionData.isHiddenApp(appId)
        ...
        Column {
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Icon {
                        name: contextMenu.isPinnedTop ? "vertical_align_top" : "vertical_align_top"
                        size: Theme.iconSize - 2
                        color: contextMenu.isPinnedTop ? Theme.primary : Theme.surfaceText
                        opacity: contextMenu.isPinnedTop ? 1.0 : 0.7
                        anchors.verticalCenter: parent.verticalCenter
                    }

                    StyledText {
                        text: contextMenu.isPinnedTop ? "Открепить сверху" : "Закрепить вверху"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceText
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        if (contextMenu.isPinnedTop) {
                            SessionData.removePinnedTopApp(contextMenu.appId)
                        } else {
                            SessionData.addPinnedTopApp(contextMenu.appId)
                        }
                        contextMenu.hide()
                    }
                }
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Icon {
                        name: contextMenu.isHidden ? "visibility" : "visibility_off"
                        size: Theme.iconSize - 2
                        color: contextMenu.isHidden ? Theme.primary : Theme.surfaceText
                        opacity: contextMenu.isHidden ? 1.0 : 0.7
                        anchors.verticalCenter: parent.verticalCenter
                    }

                    StyledText {
                        text: contextMenu.isHidden ? "Показать в списке" : "Скрыть из списка"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceText
                        font.weight: Font.Normal
                        anchors.verticalCenter: parent.verticalCenter
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        if (contextMenu.isHidden) {
                            SessionData.removeHiddenApp(contextMenu.appId)
                        } else {
                            SessionData.addHiddenApp(contextMenu.appId)
                        }
                        contextMenu.hide()
                    }
                }
            ...
            Rectangle {
                ...
                Row {
                    ...
                    StyledText {
                        text: "Запустить на дискретной GPU"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceText
                        font.weight: Font.Normal
                        anchors.verticalCenter: parent.verticalCenter
            ...
            Rectangle {
                ...
                Row {
                    ...
                    StyledText {
                        text: contextMenu.isPinned ? "Открепить от дока" : "Закрепить в доке"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceText
                        font.weight: Font.Normal
                        anchors.verticalCenter: parent.verticalCenter
