        ...
        Column {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    StyledText {
                        ...
                        text: (modelData && modelData.title) ? modelData.title: "(Без имени)"
            ...
            Rectangle {
                ...
                StyledText {
                    ...
                    anchors.rightMargin: Theme.spacingS
                    anchors.verticalCenter: parent.verticalCenter
                    text: root.appData && root.appData.isPinned ? "Открепить от дока" : "Закрепить в доке"
                    font.pixelSize: Theme.fontSizeSmall
                    color: Theme.surfaceText
                    font.weight: Font.Normal
                    elide: Text.ElideRight
