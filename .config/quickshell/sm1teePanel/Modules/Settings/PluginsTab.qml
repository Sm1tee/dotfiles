...
FocusScope {
        ...
        Column {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    StyledText {
                        text: "Размещайте папки плагинов здесь. Каждый плагин должен иметь файл манифеста plugin.json."
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceVariantText
                        wrapMode: Text.WordWrap
                        width: parent.width
            ...
            StyledRect {
                ...
                Column {
                    ...
                    Column {
                        ...
                        StyledText {
                            width: parent.width
                            text: "Плагины не найдены." + "\n" + "Поместите плагины в " + PluginService.pluginDirectory
    ...
    DankModal {
        ...
        width: Math.max(600, Math.min(850, 600 * SettingsData.fontScale))
        height: Math.max(650, Math.min(900, 650 * SettingsData.fontScale))
        allowStacking: true
        backgroundOpacity: 0
            ...
            FocusScope {
                ...
                Column {
                    ...
                    DankTextField {
                        ...
                        font.pixelSize: Theme.fontSizeMedium
                        placeholderText: "Поиск плагинов..."
    ...
    DankModal {
        ...
        height: Math.max(300, Math.min(420, 300 * SettingsData.fontScale))
        allowStacking: true
            ...
            FocusScope {
                ...
                Column {
                    ...
                    Row {
                        ...
                        StyledText {
                            text: "Предупреждение о стороннем плагине"
                            font.pixelSize: Theme.fontSizeLarge
                            font.weight: Font.Medium
                            color: Theme.surfaceText
                            anchors.verticalCenter: parent.verticalCenter
                    ...
                    StyledText {
                        width: parent.width
                        text: "Сторонние плагины созданы сообществом и официально не поддерживаются sm1teePanel.\n\nЭти плагины могут представлять угрозу безопасности и конфиденциальности - устанавливайте на свой риск."
                        font.pixelSize: Theme.fontSizeMedium
                        color: Theme.surfaceText
                        wrapMode: Text.WordWrap
                    }
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "• Плагины могут содержать ошибки или проблемы безопасности"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                        }

                        StyledText {
                            text: "• По возможности проверяйте код перед установкой"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                        }

                        StyledText {
                            text: "• Устанавливайте только из надежных источников"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                        }
                    }
