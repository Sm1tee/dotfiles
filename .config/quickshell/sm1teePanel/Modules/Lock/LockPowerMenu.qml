...
Rectangle {
    ...
    FocusScope {
        ...
        Rectangle {
            ...
            anchors.bottomMargin: buttonRef ? buttonRef.height + Theme.spacingXL + Theme.spacingM : Theme.spacingXL
            ...
            Column {
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        radius: Theme.cornerRadius
                        color: {
                            const rebootIdx = showLogout ? 1 : 0
                    ...
                    Rectangle {
                        ...
                        radius: Theme.cornerRadius
                        color: {
                            const powerOffIdx = showLogout ? 2 : 1
