...
Item {
    ...
    anchors.leftMargin: -(SettingsData.barGothCornersEnabled && axis.isVertical && axis.edge === "right" ? barWindow._wingR : 0)
    anchors.rightMargin: -(SettingsData.barGothCornersEnabled && axis.isVertical && axis.edge === "left" ? barWindow._wingR : 0)
    anchors.topMargin: -(SettingsData.barGothCornersEnabled && !axis.isVertical && axis.edge === "bottom" ? barWindow._wingR : 0)
    anchors.bottomMargin: -(SettingsData.barGothCornersEnabled && !axis.isVertical && axis.edge === "top" ? barWindow._wingR : 0)
    ...
    Canvas {
        ...
        property real wing: SettingsData.barGothCornersEnabled ? barWindow._wingR : 0
        property real rt: SettingsData.barSquareCorners ? 0 : Theme.cornerRadius
        ...
        onPaint: {
            ...
            const isTop = SettingsData.barPosition === SettingsData.Position.Top
            const isBottom = SettingsData.barPosition === SettingsData.Position.Bottom
            const isLeft = SettingsData.barPosition === SettingsData.Position.Left
            const isRight = SettingsData.barPosition === SettingsData.Position.Right
