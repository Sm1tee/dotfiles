...
Rectangle {
    ...
    readonly property int calculatedSize: {
        ...
        if (SettingsData.runningAppsCompactMode) {
            return windowCount * 24 + (windowCount - 1) * Theme.baseSpacingXS + horizontalPadding * 2;
        } else {
            return windowCount * (24 + Theme.baseSpacingXS + 120)
                    + (windowCount - 1) * Theme.baseSpacingXS + horizontalPadding * 2;
        }
    }
    ...
    Component {
        ...
        Row {
            ...
            Repeater {
                ...
                width: SettingsData.runningAppsCompactMode ? 24 : (24 + Theme.baseSpacingXS + 120)
                height: 24
                ...
                IconImage {
                    ...
                    anchors.leftMargin: SettingsData.runningAppsCompactMode ? (parent.width - 18) / 2 : Theme.baseSpacingXS
                ...
                StyledText {
                    ...
                    anchors.leftMargin: Theme.baseSpacingXS
                    ...
                    onClicked: (mouse) => {
                        if (mouse.button === Qt.LeftButton) {
                            ...
                            if (windowContextMenuLoader.item) {
                                ...
                                const yPos = root.isVertical ? delegateItem.height / 2 : (Theme.barHeight + SettingsData.barSpacing - 7);
