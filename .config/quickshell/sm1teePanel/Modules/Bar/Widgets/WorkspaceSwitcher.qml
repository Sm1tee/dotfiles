...
Rectangle {
    ...
    readonly property real padding: isVertical
        ? Math.max(Theme.baseSpacingXS, Theme.baseSpacingS * (widgetHeight / 30))
    ...
    Flow {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                width: {
                    const iconScale = SettingsData.barIconScale;
                    if (root.isVertical) {
                        ...
                        if (SettingsData.showWorkspaceApps && loadedIcons.length > 0) {
                            ...
                            const iconsWidth = numIcons * scaledIconSize + (numIcons > 0 ? (numIcons - 1) * Theme.baseSpacingXS : 0);
                            const baseWidth = isActive ? root.widgetHeight * 0.9 * iconScale + Theme.baseSpacingXS : root.widgetHeight * 0.7 * iconScale;
                ...
                height: {
                    ...
                    if (root.isVertical) {
                        if (SettingsData.showWorkspaceApps && loadedIcons.length > 0) {
                            const numIcons = Math.min(loadedIcons.length, SettingsData.maxWorkspaceIcons);
                            const scaledIconSize = Math.round(18 * iconScale);
                            const iconsHeight = numIcons * scaledIconSize + (numIcons > 0 ? (numIcons - 1) * Theme.baseSpacingXS : 0);
                            const baseHeight = isActive ? root.widgetHeight * 0.9 * iconScale + Theme.baseSpacingXS : root.widgetHeight * 0.7 * iconScale;
                        ...
                        Component {
                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    delegate: Item {
                                        width: Math.round(18 * SettingsData.barIconScale)
                                        height: Math.round(18 * SettingsData.barIconScale)
                                        ...
                                        Icon {
                                            anchors.centerIn: parent
                                            size: Math.round(18 * SettingsData.barIconScale)
                                            name: "sports_esports"
                                        ...
                                        Rectangle {
                                            anchors.fill: parent
                                            radius: Math.round(9 * SettingsData.barIconScale)
                                            ...
                                            Text {
                                                ...
                                                font.pixelSize: Math.round(Theme.fontSizeSmall * 0.9 * SettingsData.barIconScale)
