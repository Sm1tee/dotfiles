...
Rectangle {
    ...
    readonly property int trayItemSize: trayIconSize + Theme.baseSpacingS
        ...
        Rectangle {
            ...
            PanelWindow {
                ...
                function updatePosition() {
                    ...
                    const widgetThickness = Math.max(20, 26 + SettingsData.barInnerPadding * 0.6)
                    const effectiveBarThickness = Math.max(widgetThickness + SettingsData.barInnerPadding + 4, Theme.barHeight - 4 - (8 - SettingsData.barInnerPadding))

                    if (menuRoot.isVertical) {
                        const edge = menuRoot.axis?.edge
                        let targetX
                        if (edge === "left") {
                            targetX = effectiveBarThickness + SettingsData.barSpacing + Theme.popupDistance
                        } else {
                            const popupX = effectiveBarThickness + SettingsData.barSpacing + Theme.popupDistance
                        ...
                        if (menuRoot.isAtBottom) {
                            const popupY = effectiveBarThickness + SettingsData.barSpacing + SettingsData.barBottomGap + Theme.popupDistance
                            targetY = screen.height - popupY
                        } else {
                            targetY = effectiveBarThickness + SettingsData.barSpacing + SettingsData.barBottomGap + Theme.popupDistance
                        }
                ...
                Rectangle {
                    ...
                    width: Math.min(500, Math.max(250, menuColumn.implicitWidth + Theme.baseSpacingS * 2))
                    height: Math.max(40, menuColumn.implicitHeight + Theme.baseSpacingS * 2)
                    ...
                    Column {
                        ...
                        width: parent.width - Theme.baseSpacingS * 2
                        anchors.horizontalCenter: parent.horizontalCenter
                        anchors.top: parent.top
                        anchors.topMargin: Theme.baseSpacingS
                        spacing: 1
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                anchors.leftMargin: Theme.baseSpacingS
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                Row {
                                    ...
                                    anchors.rightMargin: Theme.baseSpacingS
                                    anchors.verticalCenter: parent.verticalCenter
                                    spacing: Theme.baseSpacingXS
