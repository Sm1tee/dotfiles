...
Rectangle {
    ...
    readonly property int currentContentWidth: {
        ...
        const controlsWidth = 20 + Theme.baseSpacingXS + 24 + Theme.baseSpacingXS + 20;
        const audioVizWidth = 20;
        const contentWidth = audioVizWidth + Theme.baseSpacingXS + controlsWidth;
        return contentWidth + (textWidth > 0 ? textWidth + Theme.baseSpacingXS : 0) + horizontalPadding * 2;
    }
    readonly property int currentContentHeight: {
        ...
        return audioVizHeight + Theme.baseSpacingXS + playButtonHeight + horizontalPadding * 2;
    }
