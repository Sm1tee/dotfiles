        ...
        onEntered: {
            if (root.isVertical && activeWindow && activeWindow.appId && root.parentScreen) {
                ...
                if (tooltipLoader.item) {
                    ...
                    const tooltipX = root.axis?.edge === "left" ? (Theme.barHeight + SettingsData.barSpacing + Theme.baseSpacingXS) : (currentScreen.width - Theme.barHeight - SettingsData.barSpacing - Theme.baseSpacingXS)
