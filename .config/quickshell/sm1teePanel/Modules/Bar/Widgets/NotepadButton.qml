...
Rectangle {
    ...
    Rectangle {
        ...
        anchors.rightMargin: SettingsData.barNoBackground ? 0 : 4
        anchors.topMargin: SettingsData.barNoBackground ? 0 : 4
        visible: NotepadStorageService.tabs && NotepadStorageService.tabs.length > 1
        opacity: 0.8
    }
