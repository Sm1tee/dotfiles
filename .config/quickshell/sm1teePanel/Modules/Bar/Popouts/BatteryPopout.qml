...
Popout {
    ...
    popupWidth: Math.max(580, Math.min(800, 580 * SettingsData.fontScale))
    popupHeight: contentLoader.item ? contentLoader.item.implicitHeight : Math.max(400, Math.min(550, 400 * SettingsData.fontScale))
    triggerX: Screen.width - 560 - Theme.spacingL
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                StyledText {
                                    text: BatteryService.batteryAvailable ? `${BatteryService.batteryLevel}%` : "Управление"
                                ...
                                StyledText {
                                    text: BatteryService.batteryAvailable ? BatteryService.batteryStatus : "питанием"
                            ...
                            StyledText {
                                text: {
                                    if (!BatteryService.batteryAvailable) return "Управление профилями питания доступно"
                                    const time = BatteryService.formatTimeRemaining();
                                    if (time !== "Unknown") {
                                        return BatteryService.isCharging ? `Время до полной зарядки: ${time}` : `Осталось времени: ${time}`;
                                    }
                                    return "";
                                }
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            Column {
                                ...
                                StyledText {
                                    text: "Снижение производительности профиля питания"
                                    font.pixelSize: Theme.fontSizeLarge
                                    color: Theme.error
                                    font.weight: Font.Medium
                                }
