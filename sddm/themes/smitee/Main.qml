...
Pane {
    ...
    Item {
        ...
        MultiEffect {
            ...
            // ширина: config.FullBlur == "true" ? parent.width : form.width
            // якоря.centerIn: config.FullBlur == "true" ? parent : form

            // Это решает проблему, когда FullBlur и HaveFormBackground установлены в true, но PartialBlur в false и FormPosition не является center.
